...
export function parseOxConfFile(oxFile, fileContent, onFileParsed) {
    if (fileContent === undefined) {
        ...
        try {
            onFileParsed(fileContent, processOxConfFileContent(fileContent));
        }
        catch (e) {
            alert("Parsing of included oxDNA file failed: " + fileContent, e);
        }
    }
}
